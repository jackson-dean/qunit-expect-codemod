...
const CodeMod = require('../qunit-expect-code-mod-codemod');

const fixtureFolder = `${__dirname}/../__testfixtures__/qunit-expect-code-mod`;

describe('qunit-expect-code-mod', function() {
  fs
